...
/**
 * The class of the Main menu when starting the application.
 */
public class MenuView {
	...
	/**
	 * Creates the main menu with the stage, controller, and model.
	 * 
	 * @param stage      The Stage class object represents the stage of the menu.
	 * @param controller The Controller class object represents the controller.
	 * @param model      The Model class object represents the model.
	 */
